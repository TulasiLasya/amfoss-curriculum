...
dependencies {
    ...
    // Compose BOM (Single declaration - this manages versions for all Compose libraries)
    implementation(platform(libs.androidx.compose.bom))

    // Compose dependencies (versions managed by BOM - NO version numbers needed)
