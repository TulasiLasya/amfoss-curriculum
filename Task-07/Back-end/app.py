...
class SearchSongs(Resource):
    ...
    def get(self):
        ...
        try :
            ...
            import requests
            responce = requests.get("https://free-music-api2.vercel.app/getSongs") # this will get the full list of songs 
...
def get_songs():
    try:
        ...
        if response.status_code == 200:
            ...
            return jsonify({'error': 'Failed to fetch songs from external API'}), response.status_code
